...
def load_and_cache_examples(args, tokenizer, mode):
    ...
    all_intent_label_ids = paddle.to_tensor([f.intent_label_id for f in features], dtype=paddle.int64)
    all_slot_labels_ids = paddle.to_tensor([f.slot_labels_ids for f in features], dtype=paddle.int64)
