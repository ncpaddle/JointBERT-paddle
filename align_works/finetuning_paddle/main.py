...
def getArgs():
    ...
    parser.add_argument("--task", default='data_atis', required=True, type=str, help="The name of the task to train")
    parser.add_argument("--model_dir", default='snips_model', required=True, type=str,
