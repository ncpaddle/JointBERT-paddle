...
from paddlenlp.transformers import BertTokenizer, DistilBertTokenizer, AlbertTokenizer
...
def load_tokenizer(args):
    return MODEL_CLASSES[args.model_type][1].from_pretrained(args.model_name_or_path)
